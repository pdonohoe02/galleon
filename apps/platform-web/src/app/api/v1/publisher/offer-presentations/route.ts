  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        { ok: false, error: { code: "REQUEST_INVALID", message: "The offer presentation request is invalid.", retryable: false, request_id: crypto.randomUUID() } },
        { status: 400 },
      );
    }
    return NextResponse.json(await galleon.createOfferPresentation({
